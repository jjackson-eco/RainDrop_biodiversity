...
cover19_20_tidy <- cover19_20 %>%
  ...
  dplyr::select(year, month, block, treatment,
                species = Species, plant_type = Plant_Type,
...
cover16_18_tidy <- cover16_18 %>%
  ...
  dplyr::select(year, month, block = Block, treatment = Treatment,
                species_level, species = Species, plant_type = Plant_Type,
                percent_cover = Percent_Cover)
...
save(biomass, percent_cover, file = "../../RainDropRobotics/Data/raindrop_biodiversity_2016_2020.RData")
